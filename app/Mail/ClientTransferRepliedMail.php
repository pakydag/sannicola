...
class ClientTransferRepliedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Nuova risposta da ' . $this->transferRequest->nome . ' ' . $this->transferRequest->cognome . ' - Richiesta Transfer',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.client_transfer_replied',
            with: [
