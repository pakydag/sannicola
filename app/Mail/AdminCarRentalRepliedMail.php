...
class AdminCarRentalRepliedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Nuovo messaggio in merito alla tua richiesta di noleggio auto - ' . config('app.name'),
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.admin_car_rental_replied',
            with: [
