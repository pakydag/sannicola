                    ...
                    <div x-show="activeTab === 'gallery'" class="bg-indigo-50 p-6 rounded-lg border border-indigo-100 shadow-inner">
                        <form action="{{ route('admin.global-widgets.store') }}" method="POST">
                            ...
                            <div id="gallery-container" class="space-y-3 mb-4">
                                <div class="flex items-center space-x-4 gallery-row mb-6 p-4 bg-white/40 rounded-xl border border-indigo-100">
                                    <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                        ...
                                        <div>
                                            <input type="text" name="data[photos][0][titolo]" placeholder="Titolo Slide (opzionale)" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                        </div>
                                        <div>
                                            <input type="text" name="data[photos][0][sottotitolo]" placeholder="Sottotitolo Slide (opzionale)" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                        </div>
                                        <div class="md:col-span-2">
                                            <input type="text" name="data[photos][0][link]" placeholder="Link Opzionale" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                        </div>
                                    </div>
                                    <button type="button" class="btn-rimuovi-foto text-red-500 opacity-50 hover:opacity-100 self-center"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg></button>
                                </div>
                            </div>
                    ...
                    document.getElementById('btn-aggiungi-foto').addEventListener('click', () => {
                        ...
                        row.innerHTML = `
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                ...
                                <div>
                                    <input type="text" name="data[photos][${photoIndex}][titolo]" placeholder="Titolo Slide (opzionale)" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                </div>
                                <div>
                                    <input type="text" name="data[photos][${photoIndex}][sottotitolo]" placeholder="Sottotitolo Slide (opzionale)" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                </div>
                                <div class="md:col-span-2">
                                    <input type="text" name="data[photos][${photoIndex}][link]" placeholder="Link Opzionale" class="shadow border rounded w-full py-2 px-3 focus:outline-none text-sm">
                                </div>
                            </div>
