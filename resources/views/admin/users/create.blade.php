                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="surname" id="surname" value="{{ old('surname') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input id="is_super_admin" name="is_super_admin" type="checkbox" value="1" {{ old('is_super_admin') ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                        </div>
                                    ...
                                    <div class="space-y-2 pl-7 pt-2">
                                        ...
                                        <div class="flex items-center">
                                            <input id="can_manage_site" name="can_manage_site" type="checkbox" value="1" {{ old('can_manage_site') ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                            <label for="can_manage_site" class="ml-2 text-sm text-gray-700">Sito (Articoli, Sezioni, Widget)</label>
                                        </div>

                                        <div class="flex items-center">
                                            <input id="can_manage_shop" name="can_manage_shop" type="checkbox" value="1" {{ old('can_manage_shop') ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
