                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="space-y-2 pl-7 pt-2">
                                        ...
                                        <div class="flex items-center">
                                            <input id="can_manage_agents" name="can_manage_agents" type="checkbox" value="1" {{ old('can_manage_agents', $user->can_manage_agents) ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
