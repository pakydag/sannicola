                ...
                <div class="p-6 text-gray-900">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                            <form action="{{ route('admin.vapi.tickets.bulk-sync') }}" method="POST">
                                @csrf
                                <button type="submit" class="bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-2 rounded-md text-sm font-bold border border-slate-300 transition-colors">
                                    🔄 Sincronizza Tutto
                                </button>
                            </form>
