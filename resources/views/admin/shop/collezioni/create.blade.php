<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Crea Nuova Collezione Shop') }}</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.shop.collezioni.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex mt-1 relative rounded-md shadow-sm max-w-lg">
                                <input type="text" id="foto" name="foto" value="{{ old('foto') }}" readonly placeholder="Seleziona Immagine..." class="shadow border rounded-l w-full py-2 px-3 bg-white focus:outline-none">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Tag Esistenti</label>
