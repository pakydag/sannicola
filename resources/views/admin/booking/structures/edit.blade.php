                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                        @foreach($services as $service)
                                            <label class="flex items-center gap-3 cursor-pointer bg-white p-3 rounded-xl border border-gray-200 hover:border-indigo-300 transition-all shadow-sm">
                                                <input type="checkbox" name="services[]" value="{{ $service->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 shrink-0" {{ $structure->services->contains($service->id) ? 'checked' : '' }}>
                            ...
                            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex items-stretch">
                                        <input type="text" name="seo_image" id="seo_image" value="{{ old('seo_image', $structure->seo_image) }}" readonly placeholder="Seleziona Immagine da File Manager..." class="shadow appearance-none border rounded-l flex-1 py-2 px-3 bg-white text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    ...
                                    @if($structure->seo_image)
                                        <div class="mt-2 text-sm text-gray-600">
                                            <img src="{{ asset($structure->seo_image) }}" class="h-20 w-auto object-cover mt-1 border rounded shadow-sm">
                                        </div>
                                    @endif
