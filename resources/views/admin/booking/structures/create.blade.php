                    ...
                    <form action="{{ route('admin.booking.structures.store') }}" method="POST">
                        ...
                        <div x-show="tab === 'generale'" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                @if($englishEnabled)
                                    <div class="col-span-2 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                        ...
                                        <input type="text" name="nome_en" value="{{ old('nome_en') }}" required class="shadow border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 bg-white">
                                    </div>
                                @endif
                                <div>
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="prenotabile" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm" {{ old('prenotabile', true) ? 'checked' : '' }}>
                                    <div class="ml-2">
                        ...
                        <div x-show="tab === 'descrizione'" class="space-y-4" style="display:none;">
                            ...
                            @if($englishEnabled)
                                <div class="bg-indigo-50/30 p-4 rounded border border-indigo-100/50 mt-4">
                                    ...
                                    <textarea name="descrizione_en" id="descrizione_en" class="w-full">{{ old('descrizione_en') }}</textarea>
                                </div>
                            @endif
                        </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                ...
                                @if($englishEnabled)
                                    <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                        ...
                                        <input type="text" name="seo_title_en" id="seo_title_en" value="{{ old('seo_title_en') }}" placeholder="English SEO title..." class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 bg-white leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                @if($englishEnabled)
                                    <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                        ...
                                        <textarea name="seo_description_en" id="seo_description_en" rows="3" class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 bg-white leading-tight focus:outline-none focus:shadow-outline" placeholder="English SEO description...">{{ old('seo_description_en') }}</textarea>
