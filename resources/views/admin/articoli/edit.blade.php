                            ...
                            <form :action="editingWidget ? '/amministrazione/widgets/' + editingWidget.id : '{{ route('admin.widgets.store', $articolo) }}'" method="POST">
                                ...
                                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                                    <div class="flex-1 w-full">
                                        ...
                                        @if($englishEnabled)
                                        <div class="mt-3 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                            <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Gallery * [INGLESE]</label>
                                            <input type="text" name="titolo_en" class="shadow-sm border-0 rounded-xl w-full py-2.5 px-4 focus:ring-2 focus:ring-indigo-500 text-sm">
                                        </div>
                                        @endif
                                    </div>
