...
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                        ...
                        <!-- Titolo -->
                        <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                            <label for="titolo" class="block text-gray-700 text-sm font-bold mb-2">Titolo * [INGLESE]</label>
                            <input type="text" name="titolo_en" id="titolo" value="{{ old('titolo', $articolo->titolo) }}" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            @error('titolo') <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p> @enderror
                        </div>
@endif
                        ...
                        @if($englishEnabled)
                            <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                ...
                                <input type="text" name="titolo_en" id="titolo_en" value="{{ old('titolo_en', $articolo->titolo_en) }}" required
                        ...
                        @if($englishEnabled)
                            <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                ...
                                <input type="text" name="sottotitolo_en" id="sottotitolo_en" value="{{ old('sottotitolo_en', $articolo->sottotitolo_en) }}"
                                    class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="has_transfer_form" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('has_transfer_form', $articolo->has_transfer_form) ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="has_car_rental_form" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('has_car_rental_form', $articolo->has_car_rental_form) ? 'checked' : '' }}>
                        ...
                        @if($englishEnabled)
                            <div class="mb-4 bg-indigo-50/30 p-4 rounded border border-indigo-100/50">
                                ...
                                <textarea name="descrizione_en" id="descrizione_en" rows="5"
                                    class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white">{{ old('descrizione_en', $articolo->descrizione_en) }}</textarea>
                            ...
                            <div class="p-6">
                                ...
                                @if($englishEnabled)
                                    <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                        ...
                                        <input type="text" name="seo_title_en" id="seo_title_en" value="{{ old('seo_title_en', $articolo->seo_title_en) }}" placeholder="English SEO title..."
                                            class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white">
                                ...
                                @if($englishEnabled)
                                    <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                        ...
                                        <textarea name="seo_description_en" id="seo_description_en" rows="3"
                                            class="shadow appearance-none border border-indigo-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white" placeholder="English SEO description...">{{ old('seo_description_en', $articolo->seo_description_en) }}</textarea>
                    ...
                    <div class="border-t pt-6" id="widget-form-container">
                        ...
                        <div x-show="activeTab === 'gallery'" class="bg-indigo-50 p-6 rounded-3xl border border-indigo-100 shadow-sm transition-all" :class="editingWidget ? 'ring-2 ring-indigo-500 bg-white' : ''">
                            ...
                            <form :action="editingWidget ? '/amministrazione/widgets/' + editingWidget.id : '{{ route('admin.widgets.store', $articolo) }}'" method="POST">
                                ...
                                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                                    <div class="flex-1 w-full">
                                        <label class="block text-indigo-900 font-extrabold mb-1 uppercase text-xs tracking-widest">Titolo Gallery * [INGLESE]</label>
                                        <input type="text" name="titolo_en"  x-model="formTitolo" placeholder="es. I nostri momenti" class="shadow-sm border-0 rounded-xl w-full py-2.5 px-4 focus:ring-2 focus:ring-indigo-500 text-sm">
                                    </div>
@endif
...
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                    ...
                                    <input type="text" name="titolo_en"  x-model="formTitolo" class="shadow appearance-none border rounded w-full py-2 px-3 focus:outline-none" placeholder="es. Messaggio di benvenuto">
                                </div>
@endif
...
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Interno Admin * [INGLESE]</label>
                                    <input type="text" name="titolo_en"  x-model="formTitolo" class="shadow appearance-none border rounded w-full py-2 px-3 focus:outline-none focus:shadow-outline">
                                </div>
@endif
...
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">File Video (MP4) *</label>
                                    <div class="flex mt-1 relative rounded-md shadow-sm">
                                        <input type="text" id="video_url" name="data[video_url]" readonly  placeholder="URL Video dal File Manager (es: .mp4)" class="shadow appearance-none border rounded-l w-full py-2 px-3 bg-white focus:outline-none">
                                        <button type="button" id="btn-sfoglia-video" class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none">
                                            <span>Scegli MP4...</span>
                                        </button>
                                    </div>
                        ...
                        <div x-show="activeTab === 'mirror'" style="display: none;" class="bg-indigo-50 p-6 rounded-lg border border-indigo-100 shadow-inner">
                            <form action="{{ route('admin.widgets.store', $articolo) }}" method="POST">
                                ...
                                <input type="hidden" name="tipo" value="mirror_blocks">
                                <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Blocchi (Opzionale) [INGLESE]</label>
                                    <input type="text" name="titolo_en" class="shadow appearance-none border rounded w-full py-2 px-3 focus:outline-none focus:shadow-outline" placeholder="Lascia vuoto per non mostrare un titolo globale">
                                </div>
@endif
...
<div>
                                        <label class="block text-gray-700 text-sm font-bold mb-2">Sezione Sorgente *</label>
                                        <select name="data[source_section_id]"  class="shadow border rounded w-full py-2 px-3 focus:outline-none">
                                            <option value="">-- Scegli da quale sezione pescare articoli --</option>
                                            @foreach(\App\Models\Section::all() as $sez)
                                                <option value="{{ $sez->id }}">{{ $sez->nome }}</option>
                                            @endforeach
                                    ...
                                    <div>
                                        <label class="block text-gray-700 text-sm font-bold mb-2">Numero di Articoli *</label>
                                        <select name="data[limit]"  class="shadow border rounded w-full py-2 px-3 focus:outline-none">
                                            @for($i=1; $i<=10; $i++)
                                                <option value="{{ $i }}">{{ $i }} Articoli</option>
                                            @endfor
                                        </select>
                    ...
                    <div x-show="activeTab === 'info_blocks'" style="display: none;" class="bg-indigo-50 p-6 rounded-lg border border-indigo-100 shadow-inner">
                        <form action="{{ route('admin.widgets.store', $articolo) }}" method="POST">
                            ...
                            <input type="hidden" name="tipo" value="info_blocks">
                            <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Sezione (Opzionale) [INGLESE]</label>
...
<div>
                    ...
                    <div x-show="activeTab === 'map'" style="display: none;" class="bg-indigo-50 p-6 rounded-lg border border-indigo-100 shadow-inner">
                        <form action="{{ route('admin.widgets.store', $articolo) }}" method="POST">
                            ...
                            <input type="hidden" name="tipo" value="map">
                            <div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Mappa (Opzionale) [INGLESE]</label>
                                <input type="text" name="titolo_en" class="shadow appearance-none border rounded w-full py-2 px-3 focus:outline-none focus:shadow-outline" placeholder="es. Dove siamo">
                            </div>
@endif
...
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                ...
                                <input type="text" name="data[subtitle_en]" class="shadow appearance-none border rounded w-full py-2 px-3 focus:outline-none focus:shadow-outline">
                            </div>
@endif
...
<div>
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Immagine Sfondo / Principale</label>
                                    <div class="flex mt-1 relative rounded-md shadow-sm">
                                        <input type="text" id="single_block_image" name="data[image]" readonly  placeholder="URL Immagine dal File Manager" class="shadow appearance-none border rounded-l w-full py-2 px-3 bg-white focus:outline-none focus:shadow-outline">
                                        <button type="button" id="btn-sfoglia-single" class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none">
                                            <span>Scegli Foto...</span>
                                        </button>
                                    </div>
...
@if($englishEnabled)
<div class="mb-4 bg-indigo-50/30 p-3 rounded border border-indigo-100/50">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Titolo Widget (Opzionale) [INGLESE]</label>
