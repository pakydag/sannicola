            ...
            @if($widget)
                    ...
                    @elseif($widget->tipo === 'single_block')
                        <div class="max-w-7xl mx-auto mb-12 widget-block overflow-hidden">
                            @if($widget->titolo)<h2 class="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl mb-4 mt-12 pb-4">{{ $widget->titolo }}</h2>
                            @endif
                    ...
                    @elseif($widget->tipo === 'info_blocks')
                        <div class="max-w-7xl mx-auto mb-12 py-12 widget-block bg-white p-8 overflow-hidden">
                            @if($widget->titolo)<h2 class="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl mb-8 pb-4 border-b border-gray-100">{{ $widget->titolo }}</h2>
                            @endif
