...
@section('content')
    <div class="bg-gray-50 pb-16">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="titoli text-center mb-16 bg-white py-12 border-t-0 shadow-sm rounded-b-lg border border-gray-100">
                <h1 class="text-4xl sm:text-5xl">Le Nostre Strutture</h1>
                <h2 class="mt-4 text-xl">Prenota il tuo soggiorno ideale in una delle nostre fantastiche location.</h2>
            </div>
        @else
