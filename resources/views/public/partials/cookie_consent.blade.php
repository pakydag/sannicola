...
>
    ...
    >
        <div class="bg-white rounded-3xl shadow-[0_30px_70px_-15px_rgba(0,0,0,0.5)] ring-1 ring-gray-900/10 p-6 sm:p-8 border-t-2 border-secondary relative overflow-hidden pointer-events-auto">
            ...
            <div class="flex flex-col gap-4">
                <div class="bg-gray-100 w-12 h-12 rounded-2xl flex items-center justify-center border border-gray-100">
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-900 mb-2 leading-tight">Privacy & Cookies</h4>
                    <p class="text-sm leading-relaxed text-gray-600 mb-6">
                        ...
                        <button @click="showSettings = true" class="text-primary font-bold hover:underline">Impostazioni</button>.
                    </p>
                    
                    <div class="flex flex-col gap-2">
                        <button @click="acceptAll()" class="w-full bg-primary text-white py-4 rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-secondary shadow-xl shadow-gray-100 transition-all active:scale-[0.97]">Accetta tutto</button>
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4 sm:p-6 pointer-events-auto" style="z-index: 2147483647 !important;">
            ...
            >
                ...
                <div class="space-y-4 sm:space-y-5 max-h-[50vh] overflow-y-auto px-1 custom-scrollbar">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <label class="font-bold text-gray-900 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="block text-[10px] text-primary uppercase font-black tracking-widest">Sempre Attivi</span>
                                </div>
                            </label>
                            <div class="w-12 h-6 bg-primary/20 rounded-full relative opacity-50"><div class="absolute right-1 top-1 bg-primary w-4 h-4 rounded-full"></div></div>
                        </div>
                    ...
                    <!-- Analitici -->
                    <div class="p-5 rounded-3xl bg-white border border-gray-100 hover:border-gray-100 transition-all group">
                        <div class="flex items-center justify-between mb-2">
                            <label class="font-bold text-gray-900 flex items-center gap-3">
                                <span class="bg-gray-50 p-2 rounded-xl shadow-sm group-hover:bg-gray-100 text-lg transition-colors">📈</span>
                                <span>Statistiche e Analytics</span>
                            </label>
                            <button @click="prefs.analytics = !prefs.analytics" 
                                    :class="prefs.analytics ? 'bg-primary' : 'bg-gray-200'"
                    ...
                    <div class="p-5 rounded-3xl bg-white border border-gray-100 hover:border-gray-100 transition-all group">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <button @click="prefs.marketing = !prefs.marketing" 
                                    :class="prefs.marketing ? 'bg-primary' : 'bg-gray-200'"
                                    class="relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-all duration-300">
                ...
                <div class="mt-12 pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex gap-4 w-full sm:w-auto">
                        ...
                        <button @click="savePrefs()" class="flex-1 sm:flex-none bg-primary text-white px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-secondary shadow-gray-100 transition-all">Salva scelte</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    >
        <button @click="visible = true; showSettings = true" 
                class="bg-gray-900 text-white p-4 rounded-full shadow-[0_15px_40px_rgba(0,0,0,0.4)] hover:bg-primary hover:scale-110 active:scale-90 transition-all border-4 border-white"
